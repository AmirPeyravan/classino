<x-guest-layout>
    ...
    <div class="form-container">
        <!-- Session Status -->
        <x-auth-session-status class="mb-4 form-status" :status="session('status')" />
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group mt-4">
                ...
                <x-text-input id="password" class="block mt-1 w-full" type="password" name="password" required autocomplete="current-password" aria-describedby="passwordarters-error" />
            ...
            <div class="form-checkbox mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    ...
                    <span class="ms-2">{{ __('مرا به خاطر بسپار') }}</span>
                </label>
            </div>
            ...
            <div class="form-actions mt-4">
                ...
                <x-primary-button class="ms-3 form-button">
                    {{ __('ورود') }}
                </x-primary-button>
            </div>
        </form>
