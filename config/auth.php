...
return [
    ...
    */
    ...
    | which utilizes session storage plus the Eloquent student provider.
    |
    | All authentication guards have a student provider, which defines how the
    ...
    */
    ...
    | and the student provider that is invoked to actually retrieve users.
    |
